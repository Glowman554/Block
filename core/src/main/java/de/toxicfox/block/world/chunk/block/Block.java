...
public enum Block {
    ...
    WOODSTAIR("WoodStair", (byte) 20, new StairModel(), Set.of(BlockTags.STAIR)),
    STONESTAIR("StoneStair", (byte) 21, new StairModel(), Set.of(BlockTags.STAIR)),
    DIRTSTAIR("DirtStair", (byte) 22, new StairModel(), Set.of(BlockTags.STAIR))
    ;
